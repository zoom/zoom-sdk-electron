      ...
      */
      StartMeeting: function (opts) {
        if (_addon) {
          ...
          let result = _addon.Start(Number(meetingnum), directshareappwndhandle.toString(), participantid, isvideooff, isaudiooff, isdirectsharedesktop);
          if (result == 0) {
      ...
      */
      StartMeetingWithOutLogin: function (opts) {
        if (_addon) {
          ...
          let isvideooff = (clientOpts.isvideooff === undefined) ? false : clientOpts.isvideooff;
          let isaudiooff = (clientOpts.isaudiooff === undefined) ? false : clientOpts.isaudiooff;
          return _addon.Start_WithoutLogin(userid, zoomaccesstoken, username, Number(zoomusertype), Number(meetingnumber),
      ...
      */
      JoinMeeting: function (opts) {
        if (_addon) {
          ...
          let isaudiooff = (clientOpts.isaudiooff === undefined) ? false : clientOpts.isaudiooff;
          let isdirectsharedesktop = (clientOpts.isdirectsharedesktop === undefined) ? false : clientOpts.isdirectsharedesktop;
          let result =  _addon.Join(Number(meetingnum), vanityid, username, psw, directshareappwndhandle.toString(),
      ...
      */
      JoinMeetingWithoutLogin: function (opts) {
        if (_addon) {
          ...
          let isvideooff = (clientOpts.isvideooff === undefined) ? false : clientOpts.isvideooff;
          let isaudiooff = (clientOpts.isaudiooff === undefined) ? false : clientOpts.isaudiooff;
          return _addon.Join_WithoutLogin(Number(meetingnum), vanityid, username, psw, directshareappwndhandle.toString(), userZAK,
